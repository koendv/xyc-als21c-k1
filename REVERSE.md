...
- For automatic placement, SMD re-reeling services exist that accept a tape-and-reel with components, and make a tape with the components upside-down. The XYC-ALS21C-K1 has the same size as an 1206 LED, a common component for reverse mounting.
